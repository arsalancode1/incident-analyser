...
def explain_delta(
    ...
    for _ in range(max_depth):
        ...
        for f in remaining:
            ...
            # land on, so a 0.81/0.19 split drops a slice that is genuinely
            # broken while a 0.70/0.29 split keeps it. Materiality doesn't
            # depend on how big the biggest contributor was.
            cum, take = 0.0, []
            for c in contribs:
